...
public class CustomEditorHandles : MonoBehaviour {
    ...
    static float s_DragHandleDoubleClickInterval = 2.5f;
    ...
    public static Vector3 DragHandle(Vector3 position, float handleSize, Handles.DrawCapFunction capFunc, Color colorSelected, out DragHandleResult result)
    {
        ...
        switch (Event.current.GetTypeForControl(id))
        {
            ...
            case EventType.MouseUp:
                ...
                {
                    //GUIUtility.hotControl = 0; //said in comments to remove this?
                    Event.current.Use();
